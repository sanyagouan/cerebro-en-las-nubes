        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.nombre ? 'border-red-500' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.telefono ? 'border-red-500' : 'border-gray-300'
                  }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.fecha ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
              {errors.fecha && (
                <div className="flex items-center gap-1 mt-1 text-sm text-red-600">
            ...
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.hora ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
              {errors.hora && (
                <div className="flex items-center gap-1 mt-1 text-sm text-red-600">
          ...
          <div>
            ...
            <input
              ...
              disabled={isSubmitting}
              className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.pax ? 'border-red-500' : 'border-gray-300'
                }`}
            />
            {errors.pax && (
              <div className="flex items-center gap-1 mt-1 text-sm text-red-600">
