    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${statusFilter === 'failed'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${statusFilter === 'no-answer'
